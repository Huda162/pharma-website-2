...
export default function BestSellerProduct() {
  ...
  const [currentPage, setCurrentPage] = useState(pageParam ? parseInt(pageParam) : 1);  const { data, loading } = useFetchData(`products_best_sellers?page=${currentPage}`);
    ...
    <>
      <LayoutHomeTwo>
        {loading ? (
          ...
          >
            <PageTitle
              title={t("Most popular sales")}
              breadcrumb={[
                { name: t("Home Page"), path: "/" },
                { name: t("Most popular sales"), path: "" },
              ]}
            />
          ...
          <div lassName="products-page-wrapper w-full">
            <div className="container-x mx-auto mt-[90px] mb-[90px]">
              <div className="flex flex-col items-center justify-center h-full">
                <img src="../../../public/assets/images/saller-7.png" width={250}/>
