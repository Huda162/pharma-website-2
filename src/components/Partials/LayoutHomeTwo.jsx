      ...
      {location.pathname === "/cart" || location.pathname === "/checkout" ? (
        <>
          ...
          <div className="w-full overflow-x-hidden ">
            ...
            <div
              className={`w-full w-[100vw] bg-primarygray min-h-[65vh] ${
                childrenClasses || ""
              }`}
        ...
        <div className="block xl:hidden">
          ...
          <CartDrawer />
          <div className={`w-full bg-primarygray overflow-x-hidden transition duration-300`}>
            <div className={`xl:block col-span-12 hidden`}>
              <HeaderTwo drawerAction={() => setDrawer(!drawer)} />
              <div
                className={`w-[100vw] min-h-[65vh] bg-primarygray  ${childrenClasses || ""}`}
                style={{ marginTop: "10vh" }}
              >
                {children && children}
              </div>
            ...
            />
            <div
              className={`w-[100vw] xl:hidden  bg-primarygray ${childrenClasses || ""}`}
              ...
              <div className="left-10 bottom-10 z-[1036] fixed  glowing-circle">
                <div className="my-1">
                  <a
                    ...
                    class="p-2 rounded-lg flex items-center border border-gray-300 justify-center transition-all duration-500 hover:border-gray-100 hover:bg-gray-100 bg-gradient-to-tr from-main-color/50 to"
                  >
                    <svg
